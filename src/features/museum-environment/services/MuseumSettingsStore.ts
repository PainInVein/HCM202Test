...
interface MuseumSettingsStore extends MuseumSettings {
    updateSetting: <K extends keyof MuseumSettings>(key: K, value: MuseumSettings[K]) => void;
...
const PRESETS: Record<string, Partial<MuseumSettings>> = {
...
export const useMuseumSettings = create<MuseumSettingsStore>((set) => ({
    ...DEFAULT_SETTINGS,
