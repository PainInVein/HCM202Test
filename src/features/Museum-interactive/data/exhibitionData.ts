...
// 14 paintings spaced evenly around the wall, avoiding the entrance gap
...
// ══════════════════════════════════════════════════════════════════════════
// Paintings ordered CHRONOLOGICALLY following the Điện Biên Phủ campaign:
//   1. Decision to launch (Dec 1953)
//   2. General Giáp — commander
//   3. Bicycle supply corps — logistics preparation
//   4-5. Hauling artillery — pre-battle preparation
//   6. National mobilization
//   7. Opening barrage (13/3/1954)
//   8. Artillery storm
//   9. French despair
//   10. Hill A1 — decisive battle
//   11. Bloody inch-by-inch combat
//   12. Victory (7/5/1954)
//   13. 56 days — symbolic summary
//   14. De Castries surrenders
// ══════════════════════════════════════════════════════════════════════════
